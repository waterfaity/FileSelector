...
public class FolderSearchBean {
    private boolean isAll;

    public FolderSearchBean() {
    }

    public FolderSearchBean(String path, String firstImgPath) {
        this.path = path;
     ...
     * 子图片集合
     */
    private List<FileSearchBean> childImgBeans;
    ...
    public void addChildImageBeans(List<FileSearchBean> data) {
    ...
    public List<FileSearchBean> getChildImgBeans() {
